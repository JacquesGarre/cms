 ...
 */
final class Version20220712103825 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE attribute (id INT AUTO_INCREMENT NOT NULL, label_id INT DEFAULT NULL, form_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, disabled TINYINT(1) DEFAULT NULL, required TINYINT(1) DEFAULT NULL, col INT DEFAULT NULL, position INT DEFAULT NULL, checked TINYINT(1) DEFAULT NULL, placeholder VARCHAR(255) DEFAULT NULL, readonly TINYINT(1) DEFAULT NULL, type VARCHAR(255) NOT NULL, default_value VARCHAR(255) DEFAULT NULL, multiple TINYINT(1) DEFAULT NULL, cols INT DEFAULT NULL, height INT DEFAULT NULL, select_type VARCHAR(255) DEFAULT NULL, select_entity VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_FA7AEFFB33B92F39 (label_id), INDEX IDX_FA7AEFFB5FF69B7D (form_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE entity (id INT AUTO_INCREMENT NOT NULL, model_id INT NOT NULL, creation_date DATETIME NOT NULL, update_date DATETIME DEFAULT NULL, INDEX IDX_E2844687975B7E7 (model_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE index_column (id INT AUTO_INCREMENT NOT NULL, view_id INT DEFAULT NULL, field_id INT NOT NULL, position INT NOT NULL, INDEX IDX_64CD788F31518C7 (view_id), INDEX IDX_64CD788F443707B0 (field_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE menu_item (id INT AUTO_INCREMENT NOT NULL, model_id INT DEFAULT NULL, view_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, link VARCHAR(255) DEFAULT NULL, position INT DEFAULT NULL, route VARCHAR(255) DEFAULT NULL, INDEX IDX_D754D5507975B7E7 (model_id), INDEX IDX_D754D55031518C7 (view_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `option` (id INT AUTO_INCREMENT NOT NULL, text VARCHAR(255) NOT NULL, disabled TINYINT(1) DEFAULT NULL, selected TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
