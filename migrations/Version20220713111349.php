 ...
 */
final class Version20220713111349 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE relation ADD view_id INT DEFAULT NULL, ADD mapped_by_id INT DEFAULT NULL');
